(function($) {
 ...
 var dzChartlist = function(){
	...
	var chartCircle = function(){
		...
		series: [90, 80, 70],
		labels: ['Protocolos LyD', 'Uso de insumo químico', 'Simbología de seguridad'],
	...
	var polarAreaCharts = function(){
		var options = {
			...
			labels: ['Evaluacion del proveedor', 'Buenos hábitos higiénicos', 'Seguridad en manipulación de insumos químicos', 'Procedimientos e implementos para la dilución'],
			fill: {
				opacity: 1,
