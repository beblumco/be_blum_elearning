                    ...
                    <div class="auth-form">
                        ...
                        <form v-on:submit.prevent="onSubmit">
                            ...
                            <div class="form-group mt-3">
                                <!-- <label class="mb-1 text-white"><strong>Protección de datos <span class="text-danger">*</span></strong></label> -->
                                <div>
                                    <input type="checkbox" v-model="checked">
                                    <!-- <span class="text-white texto-12 ml-1">
                            ...
                            <div class="text-center mt-3">
                                <button type="submit"
                                class="btn bg-white btn-block dev_button_login" style="color: #ff7f00;">Iniciar
                                    sesión</button>
                            </div>
                        </form>
                        <div class="new-account mt-3 texto-12 text-center" style="font-style: italic;">
                            <!-- <p class="text-white">¿No tienes una cuenta? <a class="text-white"
