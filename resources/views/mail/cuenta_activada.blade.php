                    ...
                    <tr>
                        <td style='padding:18.0pt 18.0pt 0pt 18.0pt;background:white'>
                            <h3 style='text-align:justify;line-height:18.0pt'><span
                                    style='font-size:19.0pt;font-family:Roboto;color:black'>Hola {{ $fullname }},</span><span style='font-size:12.0pt;font-family:Roboto'>
                                    <o:p></o:p>
                                </span></h3>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;color:black">
                                Su cuenta ha sido activada, bienvenido al Sistema Virtual de Atención Klaxen.
                            </p>
                        </td>
                    </tr>
                    <tr>
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="#ff7f00" style="border-radius: 6px;">
                                            <a href="{{ env('URL') }}" target="_blank"
                                                style="display: inline-block; padding: 16px 36px; font-family: 'Source Sans Pro', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">Iniciar sesión</a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
