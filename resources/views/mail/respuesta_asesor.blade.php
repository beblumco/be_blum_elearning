            ...
            <tr>
                <td style='padding:18.0pt 18.0pt 0pt 18.0pt;background:white'>
                    <h3 style='text-align:justify;line-height:18.0pt'><span
                            style='font-size:19.0pt;font-family:Roboto;color:black'> Hola {{ $request->nombre_com }},</span><span style='font-size:12.0pt;font-family:Roboto'>
                            <o:p></o:p>
                        </span></h3>
                </td>
            </tr>
            <tr>
                <td align="left" bgcolor="#ffffff"
                    ...
                    <p style="margin: 0;color:black">
                        El experto KLAXEN a dado respuesta a la pregunta de la capacitacion {{ $request->capacitacion }}.
                    </p>
                </td>
            </tr>
            <tr>
