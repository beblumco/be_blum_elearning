...
<html lang="es">
	...
	<body>
		...
		Preloader start
		********************-->
		<div id="preloader" style="z-index: 1050;">
		...
		***********************************-->
		 ...
		 ***********************************-->
		 ...
		 Header start
		 ***********************************-->
			@include('layout.acara.includes.header')
			 <!--**********************************
		 ...
		 Sidebar start
		 ***********************************-->
			@include('layout.acara.includes.sidebar')
		 <!--**********************************
		 Sidebar end
		 ***********************************-->
		 ...
		 ***********************************-->
		 ...
		 <!-- Funciones globales para el Loading -->
