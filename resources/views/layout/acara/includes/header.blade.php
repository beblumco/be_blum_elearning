		 <div class="header">
				 ...
				 <nav class="navbar navbar-expand">
					...
					<li class="nav-item dropdown notification_dropdown">
						...
						<div class="dropdown-menu rounded dropdown-menu-right">
							<div id="DZ_W_Notification1" class="widget-media dz-scroll p-3 height380" style="height: 140px;">
								<ul class="timeline">
									<li>
									...
									<li>
										<div class="timeline-panel">
											<div class="media mr-2">
												<img alt="image" width="50" src="{{ asset('img/2.jpg') }}">
											</div>
											<div class="media-body">
												<h6 class="mb-1">K-Learning</h6>
												<small class="d-block">Capacitación en línea</small>
											</div>
										</div>
									</li>
									...
									<li>
										<div class="timeline-panel">
											...
											<div class="media-body">
												...
												<small class="d-block">Sodexo - Bancolombia - Sucursal Unicentro - 21 Oct 2021 - 02:11 PM</small>
											</div>
										</div>
									</li>
									<li>
										<div class="timeline-panel">
											...
											<div class="media-body">
												<h6 class="mb-1">Acompañamiento</h6>
												<small class="d-block">Sodexo - Bancolombia - Sucursal Calle 101 - 21 Oct 2021 - 02:11 PM</small>
											</div>
										</div>
									</li>
									<li>
										<div class="timeline-panel">
											...
											<div class="media-body">
												<h6 class="mb-1">Acompañamiento</h6>
												<small class="d-block">Sodexo - Bancolombia - Sucursal Barrios Unidos - 21 Oct 2021 - 02:11 PM</small>
											</div>
										</div>
									</li>
								</ul>
			 ...
			 <li class="nav-item dropdown header-profile">
				 <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
					 <img src="{{ asset('img/17.jpg') }}" width="20" alt=""/>
				...
				<p class="fs-12 mb-0">Admin</p>
				 ...
				 <div class="dropdown-menu dropdown-menu-right">
					 <a href="./app-profile.html" class="dropdown-item ai-icon">
						 <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-savk" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
          ...
          <form method="POST" action="{{ route('logout') }}"  id="form_logout">
            {{ csrf_field() }}
            <a href="javascript:;" onclick="document.getElementById('form_logout').submit();" class="dropdown-item ai-icon">
              <svg id="icon-logout" xmlns="http://www.w3.org/2000/svg" class="text-savk" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
