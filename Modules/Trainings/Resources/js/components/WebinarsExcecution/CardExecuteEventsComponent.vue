    ...
    <div class="col-sm-4">
        <div class="card">
            ...
            <div class="contenedor">
                ...
                <a href="" :style="data_training.estado != 1 ? 'cursor: not-allowed;' : ''"
                ...
                <div class="porcentaje texto-encima">{{ (data_training.TRAINING_PERCENT == null ? "0" : data_training.TRAINING_PERCENT) }}%</div>
            </div>
            ...
            <div class="card-body">
                ...
                <button
                    ...
                    :disabled="data_training.estado == 1 ? false : true" @click="OnClickInitTraining" id="btnIniciarWebinar">
                    Iniciar webinar
                </button>
            </div>
        </div>
