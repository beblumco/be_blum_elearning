    ...
    >
      ...
      <tbody>
        <tr v-if="active_products.length == 0">
          <td colspan="9" class="text-center font-weight-bold">No hay pedidos cancelados por Klaxen.</td>
        </tr>
        ...
        <tr v-for="order in active_products">
          ...
          <td>
            <button class="btn btn-primary" @click="OnClickViewProductsOpenModal(order.id)">Ver productos</button>
          </td>
        </tr>
      </tbody>
    </table>
        ...
        <div class="modal-content">
          <div class="modal-header">
            ...
            <div class="modal-footer">
              <button class="btn btn-default" @click.prevent.stop="ModalProductsDetail(false,0);">Cerrar</button>
            </div>
        </div>
      </div>
  </div>
